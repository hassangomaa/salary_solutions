...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="get" style="display: flex;flex-direction: row-reverse;" action="{{ route('Reports.expensesOnlyTrashed') }}">
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <a href="{{ route('Reports.expenses') }}" class="btn btn-primary"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
