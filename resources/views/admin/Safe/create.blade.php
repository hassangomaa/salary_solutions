...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("safes.store") }}" >
            @csrf
            {{-- safe name --}}
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('balance') ? 'is-invalid' : '' }}" type="number" min="1" name="balance" id="balance" value="{{ old('balance', '') }}" required>
