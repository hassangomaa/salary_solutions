...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Modeel">
            <thead>
                <tr>
                    <th width="10">
                    ...
                    <th>
                        {{ trans('cruds.modeel.fields.name_ar') }}
                    </th>
                    <th>
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.modeels.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Modeel').DataTable(dtOverrideGlobals);
