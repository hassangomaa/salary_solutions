...
<head>
	...
	<title>الرئيسيهOne — Red Parts</title>
	<link rel="icon" type="image/png" href="images/favicon.png"><!-- fonts -->
				
	<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:400,400i,500,500i,700,700i"><!-- css -->
	<link rel="stylesheet" href="vendor/bootstrap/css/bootstrap.css">
	<link rel="stylesheet" href="vendor/owl-carousel/assets/owl.carousel.min.css">
	<link rel="stylesheet" href="vendor/photoswipe/poswipe.css">
	...
	<script>window.dataLayer = window.dataLayer || []; function gtag() { dataLayer.push(arguments); } gtag("js", جديد Date()); gtag("config", "UA-97489509-8");</script>
				...
				<!-- 				<div class="header__topbar-end">
					<div class="topbar topbar--spaceship-end">
						<div class="topbar__item-button"><a href="#" class="topbar__button"><span
									class="topbar__button-label">Compare:</span> <span
									class="topbar__button-title">5</span></a></div>
						<div class="topbar__item-button topbar__menu"><button
								class="topbar__button topbar__button--has-arrow topbar__menu-button" type="button"><span
									class="topbar__button-label">Currency:</span> <span
									class="topbar__button-title">USD</span> <span class="topbar__button-arrow"><svg
							...
							<div class="topbar__menu-body"><a class="topbar__menu-item" href="#">€ Euro</a> <a
									...
									href="#">$ US Dollar</a> <a class="topbar__menu-item" href="#">₽ Russian Ruble</a>
							</div>
						</div>
						<div class="topbar__menu"><button
								class="topbar__button topbar__button--has-arrow topbar__menu-button" type="button"><span
									class="topbar__button-label">Language:</span> <span
									class="topbar__button-title">EN</span> <span class="topbar__button-arrow"><svg
										width="7px" height="5px">
										<path
											d="M0.280,0.282 C0.645,-0.084 1.238,-0.077 1.596,0.297 L3.504,2.310 L5.413,0.297 C5.770,-0.077 6.363,-0.084 6.728,0.282 C7.080,0.634 7.088,1.203 6.746,1.565 L3.504,5.007 L0.262,1.565 C-0.080,1.203 -0.072,0.634 0.280,0.282 Z" />
									</svg></span></button>
							<div class="topbar__menu-body"><a class="topbar__menu-item" href="#"><img
										src="images/languages/language-1.png" alt=""><span>English</span> </a><a
									class="topbar__menu-item" href="#"><img src="images/languages/language-2.png"
										alt=""><span>French</span> </a><a class="topbar__menu-item" href="#"><img
										src="images/languages/language-3.png" alt=""><span>German</span> </a><a
									class="topbar__menu-item" href="#"><img src="images/languages/language-4.png"
										alt=""><span>Russian</span> </a><a class="topbar__menu-item" href="#"><img
										src="images/languages/language-5.png" alt=""><span>Italian</span></a></div>
						</div>
					</div>
				</div> -->
				...
				<div class="header__navbar">
					<div class="header__navbar-departments">
						<div class="departments"><button class="departments__button" type="button"><span
									...
									</svg> </span><span class="departments__button-title">Menu</span> <span
								...
								<div class="departments__body">
									<ul class="departments__list">
										...
										<li
											...
											<a href="#" class="departments__item-link">Headlights & Lighting <span
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
													...
													<div class="row">
														<div class="col-1of5">
															<ul
																...
																<li class="megamenu-links__item"><a
																		class="megamenu-links__item-link"
																		href="#">Suspension</a></li>
																<li class="megamenu-links__item"><a
																		class="megamenu-links__item-link"
																		href="#">Steering</a></li>
																<li class="megamenu-links__item"><a
																		class="megamenu-links__item-link" href="#">Fuel
																		Systems</a></li>
																<li class="megamenu-links__item"><a
																		class="megamenu-links__item-link"
																		href="#">Transmission</a></li>
																<li class="megamenu-links__item"><a
																		class="megamenu-links__item-link" href="#">Air
																		Filters</a></li>
															</ul>
														</div>
														<div class="col-1of5">
										...
										<li
											class="departments__item departments__item--submenu--megamenu departments__item--has-submenu">
											<a href="#" class="departments__item-link">Interior Parts <span
													class="departments__item-arrow"><svg width="7" height="11">
														<path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
													</svg></span></a>
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
										...
										<li
											class="departments__item departments__item--submenu--megamenu departments__item--has-submenu">
											<a href="#" class="departments__item-link">Tools & Garage <span
													class="departments__item-arrow"><svg width="7" height="11">
														<path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
													</svg></span></a>
										...
										<li class="departments__item"><a href="#" class="departments__item-link">Fuel
												Systems</a></li>
										<li class="departments__item"><a href="#"
												class="departments__item-link">Steering</a></li>
										<li class="departments__item"><a href="#"
												class="departments__item-link">Suspension</a></li>
										<li class="departments__item"><a href="#" class="departments__item-link">Body
												Parts</a></li>
										<li class="departments__item"><a href="#"
												class="departments__item-link">Transmission</a></li>
										<li class="departments__item"><a href="#" class="departments__item-link">Air
												Filters</a></li>
										<li class="departments__list-padding" role="presentation"></li>
									</ul>
						...
						<div class="main-menu">
							<ul class="main-menu__list">
								<li class="main-menu__item main-menu__item--submenu--menu main-menu__item--has-submenu">
									<a href="index.html" class="main-menu__link">الرئيسيه<svg width="7px" height="5px">
											<path
												d="M0.280,0.282 C0.645,-0.084 1.238,-0.077 1.596,0.297 L3.504,2.310 L5.413,0.297 C5.770,-0.077 6.363,-0.084 6.728,0.282 C7.080,0.634 7.088,1.203 6.746,1.565 L3.504,5.007 L0.262,1.565 C-0.080,1.203 -0.072,0.634 0.280,0.282 Z" />
										</svg></a>
									<!-- 									<div class="main-menu__submenu">
										<ul class="menu">
											<li class="menu__item"><a href="index.html" class="menu__link">الرئيسيهOne</a>
											</li>
											<li class="menu__item"><a href="index2.html" class="menu__link">الرئيسيهTwo</a>
											</li>
												...
												<div class="menu__submenu">
													<ul class="menu">
														<li class="menu__item"><a
																...
																class="menu__link">Variant One</a></li>
														<li class="menu__item"><a
																href="header-spaceship-variant-two.html"
																class="menu__link">Variant Two</a></li>
														<li class="menu__item"><a
																href="header-spaceship-variant-three.html"
																class="menu__link">Variant Three</a></li>
													</ul>
												</div>
											</li>
											<li class="menu__item menu__item--has-submenu"><a
												...
												<div class="menu__submenu">
													<ul class="menu">
														...
														<li class="menu__item"><a
																...
																class="menu__link">Variant Four</a></li>
														<li class="menu__item"><a
																href="header-classic-variant-five.html"
																class="menu__link">Variant Five</a></li>
													</ul>
												</div>
											</li>
											<li class="menu__item menu__item--has-submenu"><a
								...
								<li class="main-menu__item main-menu__item--submenu--menu main-menu__item--has-submenu">
									<a href="" class="main-menu__link">المتجر<svg width="7px" height="5px">
											<path
												d="M0.280,0.282 C0.645,-0.084 1.238,-0.077 1.596,0.297 L3.504,2.310 L5.413,0.297 C5.770,-0.077 6.363,-0.084 6.728,0.282 C7.080,0.634 7.088,1.203 6.746,1.565 L3.504,5.007 L0.262,1.565 C-0.080,1.203 -0.072,0.634 0.280,0.282 Z" />
										</svg></a>
									<!-- 									<div class="main-menu__submenu">
										<ul class="menu">
											...
											<li class="menu__item menu__item--has-submenu"><a
													href="shop-grid-4-columns-sidebar.html" class="menu__link">المتجرGrid
													<span class="menu__arrow"><svg width="6px" height="9px">
															<path
																d="M0.3,7.4l3-2.9l-3-2.9c-0.4-0.3-0.4-0.9,0-1.3l0,0c0.4-0.3,0.9-0.4,1.3,0L6,4.5L1.6,8.7c-0.4,0.4-0.9,0.4-1.3,0l0,0C-0.1,8.4-0.1,7.8,0.3,7.4z" />
														</svg></span></a>
											...
											<li class="menu__item"><a href="shop-right-sidebar.html"
													class="menu__link">المتجرRight Sidebar</a></li>
								...
								<!-- 								<li class="main-menu__item main-menu__item--submenu--menu main-menu__item--has-submenu">
									<div class="main-menu__submenu">
										<ul class="menu">
											<li class="menu__item menu__item--has-submenu"><a
													href="blog-classic-right-sidebar.html" class="menu__link">Blog
													Classic <span class="menu__arrow"><svg width="6px" height="9px">
															<path
																d="M0.3,7.4l3-2.9l-3-2.9c-0.4-0.3-0.4-0.9,0-1.3l0,0c0.4-0.3,0.9-0.4,1.3,0L6,4.5L1.6,8.7c-0.4,0.4-0.9,0.4-1.3,0l0,0C-0.1,8.4-0.1,7.8,0.3,7.4z" />
														</svg></span></a>
											...
											<li class="menu__item menu__item--has-submenu"><a
													href="blog-list-right-sidebar.html" class="menu__link">Blog List
													<span class="menu__arrow"><svg width="6px" height="9px">
															<path
																d="M0.3,7.4l3-2.9l-3-2.9c-0.4-0.3-0.4-0.9,0-1.3l0,0c0.4-0.3,0.9-0.4,1.3,0L6,4.5L1.6,8.7c-0.4,0.4-0.9,0.4-1.3,0l0,0C-0.1,8.4-0.1,7.8,0.3,7.4z" />
														</svg></span></a>
											...
											<li class="menu__item menu__item--has-submenu"><a
													href="blog-grid-right-sidebar.html" class="menu__link">Blog Grid
													<span class="menu__arrow"><svg width="6px" height="9px">
															<path
																d="M0.3,7.4l3-2.9l-3-2.9c-0.4-0.3-0.4-0.9,0-1.3l0,0c0.4-0.3,0.9-0.4,1.3,0L6,4.5L1.6,8.7c-0.4,0.4-0.9,0.4-1.3,0l0,0C-0.1,8.4-0.1,7.8,0.3,7.4z" />
														</svg></span></a>
											...
											<li class="menu__item"><a href="post-without-image.html"
													class="menu__link">Post Without Image</a></li>
										</ul>
									</div>
								</li> -->
								<li class="main-menu__item main-menu__item--submenu--menu main-menu__item--has-submenu">
									<a href="" class="main-menu__link">الحساب<svg width="7px" height="5px">
											<path
												d="M0.280,0.282 C0.645,-0.084 1.238,-0.077 1.596,0.297 L3.504,2.310 L5.413,0.297 C5.770,-0.077 6.363,-0.084 6.728,0.282 C7.080,0.634 7.088,1.203 6.746,1.565 L3.504,5.007 L0.262,1.565 C-0.080,1.203 -0.072,0.634 0.280,0.282 Z" />
										</svg></a>
									<!-- 									<div class="main-menu__submenu">
										<ul class="menu">
											<li class="menu__item"><a href="account-login.html" class="menu__link">Login
													& Register</a></li>
											<li class="menu__item"><a href="account-dashboard.html"
													class="menu__link">Dashboard</a></li>
											<li class="menu__item"><a href="account-garage.html"
													class="menu__link">Garage</a></li>
											<li class="menu__item"><a href="account-profile.html"
													class="menu__link">Edit Profile</a></li>
											<li class="menu__item"><a href="account-orders.html"
													class="menu__link">Order History</a></li>
											<li class="menu__item"><a href="account-order-details.html"
													class="menu__link">Order Details</a></li>
											<li class="menu__item"><a href="account-addresses.html"
													class="menu__link">Address Book</a></li>
											<li class="menu__item"><a href="account-edit-address.html"
													class="menu__link">Edit Address</a></li>
											<li class="menu__item"><a href="account-password.html"
													class="menu__link">Change Password</a></li>
										</ul>
									</div> -->
								</li>
								<li class="main-menu__item main-menu__item--submenu--menu main-menu__item--has-submenu">
									<a href="" class="main-menu__link">الصفحات<svg width="7px" height="5px">
											<path
												d="M0.280,0.282 C0.645,-0.084 1.238,-0.077 1.596,0.297 L3.504,2.310 L5.413,0.297 C5.770,-0.077 6.363,-0.084 6.728,0.282 C7.080,0.634 7.088,1.203 6.746,1.565 L3.504,5.007 L0.262,1.565 C-0.080,1.203 -0.072,0.634 0.280,0.282 Z" />
										</svg></a>
									<!-- <div class="main-menu__submenu">
										<ul class="menu">
											<li class="menu__item"><a href="about-us.html" class="menu__link">About
													Us</a></li>
											<li class="menu__item"><a href="contact-us-v1.html"
													class="menu__link">Contact Us v1</a></li>
											<li class="menu__item"><a href="contact-us-v2.html"
													class="menu__link">Contact Us v2</a></li>
											<li class="menu__item"><a href="404.html" class="menu__link">404</a></li>
											<li class="menu__item"><a href="terms.html" class="menu__link">Terms And
													Conditions</a></li>
					...
					<div class="search">
						<form action="#" class="search__body">
							<div class="search__shadow"></div><input class="search__input" type="text"
								placeholder="بحث"> <button class="search__button search__button--start"
								type="button"><span class="search__button-icon"><svg width="20" height="20">
	...
	c0,2.8,2.2,5,5,5c2.8,0,5-2.2,5-5C13,5.2,10.8,3,8,3z" />
							...
							<!-- 							<div class="search__dropdown search__dropdown--suggestions suggestions">
								<div class="suggestions__group">
									...
									<div class="suggestions__group-content"><a
											...
											<div class="suggestions__product-info">
												<div class="suggestions__product-name">اسم القطعه
												</div>
											...
											<div class="suggestions__product-info">
												<div class="suggestions__product-name">اسم القطعه													AR-19</div>
												<div class="suggestions__product-rating">
													<div class="suggestions__product-rating-stars">
														<div class="rating">
															<div class="rating__body">
								...
								<div class="suggestions__group">
									...
									<div class="suggestions__group-content"><a
											class="suggestions__item suggestions__category" href="#">Headlights &
											Lighting</a> <a class="suggestions__item suggestions__category"
											href="#">Fuel System & Filters</a> <a
											class="suggestions__item suggestions__category" href="#">Body Parts &
											...
											<div class="vehicles-list__body"><label class="vehicles-list__item"><span
														...
														class="vehicles-list__item-radio input-radio"><span
															class="input-radio__body"><input class="input-radio__input"
																...
																class="input-radio__circle"></span> </span></span><span
														class="vehicles-list__item-info"><span
															class="vehicles-list__item-name">2019 Audi Q7 Premium</span>
								...
								<div class="vehicle-picker__panel vehicle-picker__panel--form" data-panel="form">
									<div class="vehicle-picker__panel-body">
										...
										<div class="vehicle-picker__actions">
											<div class="search__car-selector-link"><a href="#" data-to-panel="list">Back
	...
	C26,18.5,30,23.8,30,30h-2C28,23.4,22.6,18,16,18z M22,10c0-3.3-2.7-6-6-6s-6,2.7-6,6s2.7,6,6,6S22,13.3,22,10z" />
								</svg> </span><span class="indicator__title">مرحبا قم بتسجيل الدخول</span> <span
								class="indicator__value">حسابى</span></a>
						<div class="indicator__content">
							<div class="account-menu">
								<form class="account-menu__form">
									<div class="account-menu__form-title">تسجيل الدخول</div>
									<div class="form-group"><label for="header-signin-email" class="sr-only">البريد
											الالكترونى
										</label> <input id="header-signin-email" type="بريد الكترونى"
											class="form-control form-control-sm" placeholder="البريد الالكترونى"></div>
									<div class="form-group"><label for="header-signin-password" class="sr-only">كلمه
											السر</label>
										<div class="account-menu__form-forgot"><input id="header-signin-password"
												type="كلمه السر" class="form-control form-control-sm"
												placeholder="كلمه السر"> <a href="#"
												class="account-menu__form-forgot-link">هل نسيت كلمه السر</a></div>
									</div>
									<div class="form-group account-menu__form-button"><button type="submit"
											class="btn btn-primary btn-sm">تسجيل</button></div>
									<div class="account-menu__form-link"><a href="account-login.html">تسجيل كعضو
											جديد</a></div>
								</form>
			...
			<div class="mobile-header">
				<div class="container">
					<div class="mobile-header__body"><button class="mobile-header__menu-button" type="button"><svg
							...
							</svg></button> <a class="mobile-header__logo" href="#"><!-- mobile-logo --> <svg
								width="130" height="20">
								<path class="mobile-header__logo-part-one" d=" "></path>
								<path class="mobile-header__logo-part-two" d=" "></path>
							</svg><!-- mobile-logo / end --></a>
						<div class="mobile-header__search mobile-search">
							<form class="mobile-search__body"><input type="text" class="mobile-search__input"
									placeholder="بحث"> <button type="button" class="mobile-search__vehicle-picker"
									aria-label="Select Vehicle"><svg width="20" height="20">
										<path d=" " />
...
<!-- mobile-menu -->
	...
	C15.5,10.2,14,11.3,14,12z" />
					...
					<div class="mobile-menu__divider"></div>
					<ul class="mobile-menu__links">
						<li data-mobile-menu-item><a href="index.html" class="" data-mobile-menu-trigger>الرئيسيه<svg
									width="7" height="11">
									<path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
								</svg></a>
									...
									<div class="mobile-menu__panel-body">
										<ul class="mobile-menu__links">
											<li data-mobile-menu-item><a href="index.html" class=""
													data-mobile-menu-trigger>الرئيسيهOne</a></li>
											<li data-mobile-menu-item><a href="index2.html" class=""
													data-mobile-menu-trigger>الرئيسيهTwo</a></li>
														...
														<div class="mobile-menu__panel-body">
															<ul class="mobile-menu__links">
																<li data-mobile-menu-item><a
																		href="header-spaceship-variant-one.html"
																		class="" data-mobile-menu-trigger>Variant
																		One</a></li>
																<li data-mobile-menu-item><a
																		href="header-spaceship-variant-two.html"
																		class="" data-mobile-menu-trigger>Variant
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
						...
						<li data-mobile-menu-item><a href="shop-grid-4-columns-sidebar.html" class=""
								data-mobile-menu-trigger>المتجر<svg width="7" height="11">
									<path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
								</svg></a>
							<div class="mobile-menu__links-panel" data-mobile-menu-panel>
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
														...
														<div class="mobile-menu__panel-body">
															<ul class="mobile-menu__links">
																...
																<li data-mobile-menu-item><a
																		...
																		data-mobile-menu-trigger>5 Columns Sidebar</a>
																</li>
																<li data-mobile-menu-item><a
											...
											<li data-mobile-menu-item><a href="shop-grid-4-columns-sidebar.html"
													class="" data-mobile-menu-trigger>المتجرGrid <svg width="7"
														height="11">
														<path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
													</svg></a>
												<div class="mobile-menu__links-panel" data-mobile-menu-panel>
													<div class="mobile-menu__panel mobile-menu__panel--hidden">
														<div class="mobile-menu__panel-header"><button
															...
															<div class="mobile-menu__panel-title">المتجرGrid</div>
														</div>
														<div class="mobile-menu__panel-body">
															<ul class="mobile-menu__links">
																<li data-mobile-menu-item><a
											...
											<li data-mobile-menu-item><a href="shop-list.html" class=""
													data-mobile-menu-trigger>المتجرList</a></li>
											<li data-mobile-menu-item><a href="shop-table.html" class=""
													data-mobile-menu-trigger>المتجرTable</a></li>
											<li data-mobile-menu-item><a href="shop-right-sidebar.html" class=""
													data-mobile-menu-trigger>المتجرRight Sidebar</a></li>
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
											...
											<li data-mobile-menu-item><a href="post-without-image.html" class=""
													data-mobile-menu-trigger>Post Without Image</a></li>
										</ul>
									</div>
								</div>
							</div>
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
									...
									<div class="mobile-menu__panel-body">
										<ul class="mobile-menu__links">
											...
											<li data-mobile-menu-item><a href="account-order-details.html" class=""
													data-mobile-menu-trigger>Order Details</a></li>
											...
											<li data-mobile-menu-item><a href="account-edit-address.html" class=""
													data-mobile-menu-trigger>Edit Address</a></li>
						...
						<li data-mobile-menu-item><a href="about-us.html" class="" data-mobile-menu-trigger>الصفحات<svg
									width="7" height="11">
									<path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
								</svg></a>
