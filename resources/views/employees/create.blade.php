        ...
        <div class="card-body">
            <form method="POST" action="{{ route("employee.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="required" for="name">{{ trans('employee.employee_name') }}</label>
                ...
                <div class="form-group">
                    <label class="required" for="position">{{ trans('employee.employee_position') }}</label>
                ...
                <div class="form-group">
                    <label class="required" for="phone">{{ trans('employee.employee_phone') }}</label>
                ...
                <div class="form-group">
                    <label class="required" for="address">{{ trans('employee.employee_address') }}</label>
