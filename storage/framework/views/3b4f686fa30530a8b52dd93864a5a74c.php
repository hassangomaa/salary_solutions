<div class="m-3">
    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="<?php echo e(route('commission.create',$employeeId)); ?>">
              Add Commission
            </a>
        </div>
    </div>
                    ...
                    <?php $__currentLoopData = $commissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $commission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($commission->id); ?>">
                            ...
                            <td>
                                ...
                                <a class="btn btn-xs btn-primary" href="<?php echo e(route('commission.show', $commission->id)); ?>">
                                ...
                                <a class="btn btn-xs btn-info" href="<?php echo e(route('commission.edit', $commission->id)); ?>">
                                ...
                                <form action="<?php echo e(route('commission.destroy', $commission->id)); ?>" method="POST" onsubmit="return confirm('<?php echo e(trans('global.areYouSure')); ?>');" style="display: inline-block;">
...
<?php /**PATH /media/hassan/AE24833A24830515/php_Projects/htdocs/projects/salary_solutions/resources/views/commission/index.blade.php ENDPATH**/ ?>