<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header">
            <?php echo e(trans('borrow.create_borrow')); ?>
        ...
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('borrowing.store')); ?>">
                ...
                <div class="form-group">
                    <label class="required" for="employee_id"><?php echo e(trans('borrow.employee')); ?></label>
                    <select class="form-control <?php echo e($errors->has('employee_id') ? 'is-invalid' : ''); ?>" name="employee_id" id="employee_id" required>
                        <option value="" disabled selected><?php echo e(trans('borrow.select_employee')); ?></option>
                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($employee->id); ?>"><?php echo e($employee->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <option value="0"><?php echo e(trans('borrow.other')); ?></option>
                    </select>
                ...
                <div class="form-group" id="otherEmployeeContainer" style="display: none;">
                    <label class="required" for="other_employee_id"><?php echo e(trans('borrow.other_employee_id')); ?></label>
                    <input type="text" class="form-control" name="other_employee_id" id="other_employee_id">
                </div>

                <div class="form-group">
                    <label class="required" for="month"><?php echo e(trans('borrow.month')); ?></label>
                    <select class="form-control <?php echo e($errors->has('month') ? 'is-invalid' : ''); ?>" name="month" id="month" required>
                        <option value="" disabled selected><?php echo e(trans('borrow.select_month')); ?></option>
                ...
                <div class="form-group">
                    <label class="required" for="amount"><?php echo e(trans('borrow.amount')); ?></label>
                ...
                <div class="form-group">
                    <label class="required" for="statement"><?php echo e(trans('borrow.statement')); ?></label>
