                    ...
                    <?php $__currentLoopData = $deductions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $deduction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($deduction->id); ?>">
                            ...
                            <td>
                                ...
                                <a class="btn btn-xs btn-primary" href="<?php echo e(route('admin.products.show', $deduction->id)); ?>">
                                ...
                                <a class="btn btn-xs btn-info" href="<?php echo e(route('admin.products.edit', $deduction->id)); ?>">
                                ...
                                <form action="<?php echo e(route('admin.products.destroy', $deduction->id)); ?>" method="POST" onsubmit="return confirm('<?php echo e(trans('global.areYouSure')); ?>');" style="display: inline-block;">
...
<?php /**PATH D:\Laragon_Projects\salary_solutions\resources\views/employees/relationships/addDeductions.blade.php ENDPATH**/ ?>