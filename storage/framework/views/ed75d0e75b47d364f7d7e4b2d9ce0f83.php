<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header">
            <?php echo e(trans('global.create')); ?> <?php echo e(trans('company-management.company_singular')); ?>
        ...
        <div class="card-body">
            <form method="POST" action="<?php echo e(route("company.store")); ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="required" for="start_month"><?php echo e(trans('company-management.start_month')); ?></label>
                ...
                <div class="form-group">
                    <label class="required" for="end_month"><?php echo e(trans('company-management.end_month')); ?></label>
