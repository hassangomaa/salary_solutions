<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header">
            <?php echo e(trans('global.edit')); ?> <?php echo e(trans('company-management.company_singular')); ?>
        ...
        <div class="card-body">
            <form method="POST" action="<?php echo e(route("company.update", $company->id)); ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="required" for="name"><?php echo e(trans('company-management.company_name')); ?></label>
                ...
                <div class="form-group">
                    <label class="required" for="address"><?php echo e(trans('company-management.company_address')); ?></label>
                ...
                <div class="form-group">
                    <label class="required" for="phone"><?php echo e(trans('company-management.company_phone')); ?></label>
                ...
                <div class="form-group">
                    <label class="required" for="credit"><?php echo e(trans('company-management.company_credit')); ?></label>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laragon_Projects\salary_solutions\resources\views/company/edit.blade.php ENDPATH**/ ?>