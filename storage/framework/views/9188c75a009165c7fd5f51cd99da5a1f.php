<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header">
            <?php echo e(trans('employee.edit_employee')); ?>
        ...
        <div class="card-body">
            <form method="POST" action="<?php echo e(route("employee.update", [$employee->id])); ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="required" for="name"><?php echo e(trans('employee.name')); ?></label>
                ...
                <div class="form-group">
                    <label class="required" for="daily_fare"><?php echo e(trans('employee.daily_fare')); ?></label>
                ...
                <div class="form-group">
                    <label class="required" for="overtime_hour_fare"><?php echo e(trans('employee.overtime_hour_fare')); ?></label>
                    <input class="form-control <?php echo e($errors->has('overtime_hour_fare') ? 'is-invalid' : ''); ?>" type="text"
                           name="overtime_hour_fare" id="overtime_hour_fare" value="<?php echo e(old('overtime_hour_fare', $employee->overtime_hour_fare)); ?>"
                           required>
                ...
                <div class="form-group">
                    <label class="required" for="position"><?php echo e(trans('employee.position')); ?></label>
                ...
                <div class="form-group">
                    <label for="phone"><?php echo e(trans('employee.phone')); ?></label>
                ...
                <div class="form-group">
                    <label for="address"><?php echo e(trans('employee.address')); ?></label>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laragon_Projects\salary_solutions\resources\views/employees/edit.blade.php ENDPATH**/ ?>