<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="<?php echo e(route("companyPayments.deposit.store")); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control <?php echo e($errors->has('type') ? 'is-invalid' : ''); ?>" type="text" name="type" id="statement" value="deposit" required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laragon_Projects\salary_solutions\resources\views/company-payments/deposit/create.blade.php ENDPATH**/ ?>